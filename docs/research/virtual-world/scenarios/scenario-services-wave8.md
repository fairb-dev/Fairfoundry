...
**Execution Timeline:** Week 1-2: Model building and mesh convergence study. Week 3: Interim model review with WindStream. Week 4-5: Fatigue analysis and report writing. Week 6: Report delivery and technical review. Week 7-8: DNV review and comments. Total: 6-8 weeks.
...
**Service Type:** Warehouse inventory audit service -- wall-to-wall physical inventory count of PulseCore's 3PL warehouse in Singapore (3,200 SKUs)
...
3. Recount trigger: any SKU with variance > 5% or material value difference is recounted by a second team
...
```
Sample count row: `WB-SENSOR-042 | Heart rate sensor module | B3-R2-S4 | LOT-2026-0118 | EA | 1,247 | 1,250 | -3 | -0.24% | variance recorded | No | N/A | 1,247`
...
**Dispute Likelihood:** Medium -- The supplier being audited may disagree with the severity rating of findings. Apex may rate a finding as "Major Gap" while the supplier considers it a "Minor Gap." The impact is significant: "Rejected" means the supplier loses a strategic Volante contract. However, the dispute is between Volante and the supplier, with Apex as the independent assessor.
...
| # | Customer | Service Provider | Service Type | Category | Dispute | Tags |
|---|---|---|---|---|---|---|
| S076 | OEM-09 Meridian Auto | Factory 39 Westlake Cal | Dimensional gauge calibration (85 instruments) | Calibration | Low | ISO 17025, ASME B89 |
| S077 | OEM-34 WindStream | Factory 32 PMS GmbH | Torque wrench calibration (22 wrenches) | Calibration | Low | ISO 6789, on-site |
| S078 | OEM-38 Nextera Process | Factory 40 Tri-State Cal | Pressure gauge calibration (45 gauges) | Calibration | Low | ASME B40.100 |
| S079 | OEM-18 Pinnacle Pharma | Factory 41 ThermalTek | RTD & thermocouple calibration (84 sensors) | Calibration | Medium | IEC 60751, FDA |
| S080 | OEM-14 Vanguard | Factory 32 PMS GmbH | Optical comparator calibration (4 units) | Calibration | Low | ISO 17025, on-site |
| S081 | OEM-21 Ironvale Steel | Factory 42 Great Lakes | Tensile testing service (120 specimens) | Testing Lab | Low | ASTM E8, ISO 6892 |
| S082 | OEM-27 Volante Auto | Factory 43 Rhine Valley | Chemical analysis ICP-OES (50 samples) | Testing Lab | Medium | ASTM E1479, ISO 17025 |
| S083 | OEM-01 Lumenar Tech | Factory 34 Ruixin Lab | Failure analysis (25 camera modules) | Testing Lab | Medium | IPC-9503 |
| S084 | OEM-35 Nextera Water | Factory 44 Gulf Coast Env | Salt spray + UV testing (60 panels) | Testing Lab | Low | ASTM B117, ASTM G154 |
| S085 | OEM-31 Krakow Elec | Factory 33 Heartland | EMC pre-compliance scan | Testing Lab | Low | CISPR 32 |
| S086 | OEM-04 Greenfield IoT | Factory 45 SiliconBridge | PCB layout design service (6-layer HDI) | Engineering | Medium | IPC-2221B |
| S087 | OEM-29 Amazonia Pkg | Factory 46 FlowSim | Mold flow simulation (48-cavity preform) | Engineering | Low | Moldex3D |
| S088 | OEM-34 WindStream | Factory 47 NordStruct | FEA fatigue analysis (tower flange) | Engineering | Medium | DNVGL-ST-0126 |
| S089 | OEM-04 Greenfield IoT | Factory 48 EmbedCore | Firmware development (BLE + OTA) | Engineering | High | BLE 5.3, MISRA-C |
| S090 | OEM-07 Radiant Optics | Factory 49 CertPath | Product certification consulting (FCC/CE/UL) | Engineering | Medium | FCC Part 15, RED |
| S091 | Factory 02 Weida (cust) | Factory 50 Haas Shanghai | CNC machine annual PM (2x VF-4SS) | Maintenance | Low | ISO 230-2, ISO 230-4 |
| S092 | Factory 05 SemiTek (cust) | Factory 51 KT-Advanced | ATE station PM (3x UltraFLEX II) | Maintenance | Low | Teradyne spec |
| S093 | OEM-20 Meridius Med | Factory 52 CleanAir | HEPA filter integrity test (24 filters) | Maintenance | Low | ISO 14644-3, FDA |
| S094 | OEM-27 Volante Auto | Factory 53 QualityFirst | Pre-shipment inspection AQL (15K units) | Inspection | Medium | ISO 2859-1 |
| S095 | OEM-09 Meridian Auto | Factory 54 SpecCheck | Incoming receiving inspection (annual) | Inspection | Low | ISO 2859-1, AS9102 |
| S096 | OEM-05 PulseCore | Factory 55 AccuCount | Warehouse inventory audit (3,200 SKUs) | Inspection | Low | SOX Sec 404 |
| S097 | OEM-27 Volante Auto | Factory 56 Apex Quality | Supplier quality audit IATF 16949 | Audit | Medium | IATF 16949, VDA 6.3 |
| S098 | Factory 02 Weida (cust) | Factory 57 TechTrain | IPC J-STD-001 CIS operator training | Training | Low | IPC J-STD-001H |
| S099 | OEM-09 Meridian Auto | Factory 58 FactoryLogic | MES system integration (Opcenter) | IT | High | ISA-95, IEC 62264 |
| S100 | OEM-18 Pinnacle Pharma | Factory 59 DataBridge | Production data migration (GxP) | IT | High | FDA 21 CFR Part 11 |
