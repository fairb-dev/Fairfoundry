//! # Fairfoundry - Manufacturing Control Records with QA & Review
//!
//! A Soroban smart contract for managing verifiable manufacturing control records between
...
//!      -> Finalized   (configured finalization path)
//!      -> Closed      (configured exception path)
//! ```
//!
