...
-- CreateTable
CREATE TABLE "FinalizationRecord" (
    "id" TEXT NOT NULL,
    "submissionId" TEXT NOT NULL,
    "contractId" TEXT NOT NULL,
    ...
    CONSTRAINT "FinalizationRecord_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "FinalizationRecord_submissionId_key" ON "FinalizationRecord"("submissionId");
...
-- AddForeignKey
ALTER TABLE "FinalizationRecord" ADD CONSTRAINT "FinalizationRecord_submissionId_fkey" FOREIGN KEY ("submissionId") REFERENCES "Submission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FinalizationRecord" ADD CONSTRAINT "FinalizationRecord_contractId_fkey" FOREIGN KEY ("contractId") REFERENCES "Contract"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
